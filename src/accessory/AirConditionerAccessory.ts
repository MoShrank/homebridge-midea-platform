...
export default class AirConditionerAccessory extends BaseAccessory<MideaACDevice> {
    ...
    constructor(
        ...
        this.fanOnlyService = this.accessory.getServiceById(
            this.platform.Service.Switch,
            fanOnlySubtype
        );
        if (this.configDev.AC_options.fanOnlyModeSwitch) {
            this.fanOnlyService ??= this.accessory.addService(
                this.platform.Service.Switch,
                undefined,
                fanOnlySubtype
            );
        ...
        // Fan accessory
        this.fanService = this.accessory.getServiceById(
        ...
        // Display switch
        this.displayService = this.accessory.getServiceById(
            this.platform.Service.Switch,
            displaySubtype
        );
        if (this.configDev.AC_options.displaySwitch.flag) {
            this.device.set_alternate_switch_display(
                this.configDev.AC_options.displaySwitch.command
            );
        ...
        // Eco mode switch
        this.ecoModeService = this.accessory.getServiceById(
            this.platform.Service.Switch,
            ecoModeSubtype
        );
        if (this.configDev.AC_options.ecoSwitch) {
            this.ecoModeService ??= this.accessory.addService(
                this.platform.Service.Switch,
                "Eco",
                ecoModeSubtype
            );
        ...
        // Breeze away switch
        this.breezeAwayService = this.accessory.getServiceById(
            this.platform.Service.Switch,
            breezeAwaySubtype
        );
        if (this.configDev.AC_options.breezeAwaySwitch) {
            this.breezeAwayService ??= this.accessory.addService(
                this.platform.Service.Switch,
                undefined,
                breezeAwaySubtype
            );
        ...
        // Dry mode switch
        this.dryModeService = this.accessory.getServiceById(
            this.platform.Service.Switch,
            dryModeSubtype
        );
        if (this.configDev.AC_options.dryModeSwitch) {
            this.dryModeService ??= this.accessory.addService(
                this.platform.Service.Switch,
                undefined,
                dryModeSubtype
            );
        ...
        // Boost mode switch
        this.boostModeService = this.accessory.getServiceById(
            this.platform.Service.Switch,
            boostModeSubtype
        );
        if (this.configDev.AC_options.boostModeSwitch) {
            this.boostModeService ??= this.accessory.addService(
                this.platform.Service.Switch,
                "Boost",
                boostModeSubtype
            );
        ...
        // Aux switch
        this.auxService = this.accessory.getServiceById(
            this.platform.Service.Switch,
            auxSubtype
        );
        if (this.configDev.AC_options.auxHeatingSwitches) {
            this.auxService ??= this.accessory.addService(
                this.platform.Service.Switch,
                undefined,
                auxSubtype
            );
            ...
            this.auxService
                .getCharacteristic(this.platform.Characteristic.On)
                .onGet(this.getAux.bind(this))
                .onSet(this.setAux.bind(this));
        } else if (this.auxService) {
            this.accessory.removeService(this.auxService);
        }

        // Aux+Heat switch
        this.auxHeatingService = this.accessory.getServiceById(
            this.platform.Service.Switch,
            auxHeatingSubtype
        );
        if (this.configDev.AC_options.auxHeatingSwitches) {
            this.auxHeatingService ??= this.accessory.addService(
                this.platform.Service.Switch,
                undefined,
                auxHeatingSubtype
            );
        ...
        this.selfCleanService = this.accessory.getServiceById(
            this.platform.Service.Switch,
            selfCleanSubtype
        );
        if (this.configDev.AC_options.selfCleanSwitch) {
            this.selfCleanService ??= this.accessory.addService(
                this.platform.Service.Switch,
                "Self-cleaning",
                selfCleanSubtype
            );
        ...
        // ION switch
        this.ionService = this.accessory.getServiceById(
            this.platform.Service.Switch,
            ionSubtype
        );
        if (this.configDev.AC_options.ionSwitch) {
            this.ionService ??= this.accessory.addService(
                this.platform.Service.Switch,
                "ION",
                ionSubtype
            );
        ...
        // Rate select slider
        this.rateSelectService = this.accessory.getServiceById(
            this.platform.Service.Lightbulb,
            rateSelectSubtype
        );
        if (this.configDev.AC_options.rateSelector) {
            this.rateSelectService ??= this.accessory.addService(
                this.platform.Service.Lightbulb,
                undefined,
                rateSelectSubtype
            );
        ...
        this.sleepModeService = this.accessory.getServiceById(
            this.platform.Service.Switch,
            sleepModeSubtype
        );
        if (this.configDev.AC_options.sleepModeSwitch) {
            this.sleepModeService ??= this.accessory.addService(
                this.platform.Service.Switch,
                undefined,
                sleepModeSubtype
            );
        ...
        this.comfortModeService = this.accessory.getServiceById(
            this.platform.Service.Switch,
            comfortModeSubtype
        );
        if (this.configDev.AC_options.comfortModeSwitch) {
            this.comfortModeService ??= this.accessory.addService(
                this.platform.Service.Switch,
                undefined,
                comfortModeSubtype
            );
            this.handleConfiguredName(
                this.comfortModeService,
                comfortModeSubtype,
                "Comfort"
            );
            this.comfortModeService
        ...
        this.swingAngleMainControl =
            swingProps.mode === SwingMode.VERTICAL ||
            (swingProps.mode === SwingMode.BOTH &&
                swingProps.angleMainControl === SwingAngle.VERTICAL)
                ? SwingAngle.VERTICAL
                : SwingAngle.HORIZONTAL;
        // Swing angle accessory
        this.swingAngleService = this.accessory.getServiceById(
            this.platform.Service.WindowCovering,
            swingAngleSubtype
        );
        if (swingProps.mode !== SwingMode.NONE && swingProps.angleAccessory) {
            this.swingAngleService ??= this.accessory.addService(
                this.platform.Service.WindowCovering,
                undefined,
                swingAngleSubtype
            );
            ...
            if (swingProps.mode === SwingMode.BOTH) {
                this.swingAngleService
                    ...
                    .onGet(
                        this.getSwingAngleCurrentHorizontalTiltAngle.bind(this)
                    );
                this.swingAngleService
                    .getCharacteristic(
                    ...
                    .onGet(
                        this.getSwingAngleTargetHorizontalTiltAngle.bind(this)
                    )
                    .onSet(
                        this.setSwingAngleTargetHorizontalTiltAngle.bind(this)
                    );
                this.swingAngleService
                    .getCharacteristic(
                    ...
                    .onGet(
                        this.getSwingAngleCurrentVerticalTiltAngle.bind(this)
                    );
                this.swingAngleService
                    .getCharacteristic(
                    ...
                    .onSet(
                        this.setSwingAngleTargetVerticalTiltAngle.bind(this)
                    );
            }
        }
        // Misc
        ...
        for (const [k, v] of Object.entries(attributes)) {
            ...
            switch (k.toLowerCase()) {
                ...
                case "mode":
                    ...
                    break;
                case "eco_mode":
                    this.ecoModeService?.updateCharacteristic(
                        this.platform.Characteristic.On,
                        this.getEcoMode()
                    );
                    break;
                case "indirect_wind":
                    this.breezeAwayService?.updateCharacteristic(
                        this.platform.Characteristic.On,
                        this.getBreezeAway()
                    );
                    break;
                case "aux_heating":
                    this.auxHeatingService?.updateCharacteristic(
                        this.platform.Characteristic.On,
                        this.getAuxHeating()
                    );
                    break;
                case "smart_eye":
                    this.auxService?.updateCharacteristic(
                        this.platform.Characteristic.On,
                        this.getAux()
                    );
                    break;
                ...
                case "wind_swing_ud_angle":
                    this.swingAngleService?.updateCharacteristic(
                        ...
                        this.getSwingAngleCurrentPosition()
                    );
                    this.swingAngleService?.updateCharacteristic(
                        this.platform.Characteristic.TargetPosition,
                        this.getSwingAngleTargetPosition()
                    );

                    if (
                        this.configDev.AC_options.swing.mode === SwingMode.BOTH
                    ) {
                        this.swingAngleService?.updateCharacteristic(
                            this.platform.Characteristic
                ...
                case "self_clean":
                    ...
                    this.selfCleanService?.updateCharacteristic(
                        this.platform.Characteristic.On,
                        this.getSelfCleanState()
                    );
                    break;
                case "ion":
                    this.ionService?.updateCharacteristic(
                        this.platform.Characteristic.On,
                        this.getIonState()
                    );
                    break;
                case "rate_select":
                    this.rateSelectService?.updateCharacteristic(
    ...
    getCurrentHeaterCoolerState(): CharacteristicValue {
        if (
            this.device.attributes.POWER &&
            this.device.attributes.MODE > 0 &&
            this.device.attributes.MODE < 5
        ) {
            if (
    ...
    getFanOnlyMode(): CharacteristicValue {
        return (
            this.device.attributes.POWER === true &&
            this.device.attributes.MODE === 5
        );
    }
    ...
    async setFanState(value: CharacteristicValue) {
        await this.device.set_fan_auto(
            value === this.platform.Characteristic.TargetFanState.AUTO
        );
    }

    async setTargetTemperature(value: CharacteristicValue) {
        await this.device.set_target_temperature(
            limitValue(
                value as number,
                this.configDev.AC_options.minTemp,
                this.configDev.AC_options.maxTemp
            ...
            case this.platform.Characteristic.SwingMode.SWING_ENABLED:
                await this.device.set_swing(
                    [SwingMode.HORIZONTAL, SwingMode.BOTH].includes(
                        this.configDev.AC_options.swing.mode
                    ),
    ...
    getEcoMode(): CharacteristicValue {
        return (
            this.device.attributes.POWER === true &&
            this.device.attributes.ECO_MODE
        );
    }
    ...
    getBreezeAway(): CharacteristicValue {
        return (
            this.device.attributes.POWER === true &&
            this.device.attributes.INDIRECT_WIND
        );
    }
    ...
    getBoostMode(): CharacteristicValue {
        return (
            this.device.attributes.POWER === true &&
            this.device.attributes.BOOST_MODE
        );
    }
    ...
    getAux(): CharacteristicValue {
        return (
            this.device.attributes.POWER === true &&
            this.device.attributes.SMART_EYE === true
        );
    }
    ...
    getAuxHeating(): CharacteristicValue {
        return (
            this.device.attributes.POWER === true &&
            this.device.attributes.AUX_HEATING === true
        );
    }
    ...
    getIonState(): CharacteristicValue {
        return (
            this.device.attributes.POWER === true &&
            this.device.attributes.ION === true
        );
    }
    ...
    async setSwingAngleTargetPosition(value: CharacteristicValue) {
        await this.device.set_swing_angle(
            this.swingAngleMainControl,
    ...
    getSwingAngleCurrentHorizontalTiltAngle(): CharacteristicValue {
        return this.device.attributes.WIND_SWING_LR_ANGLE === 1
            ? 0
            : this.device.attributes.WIND_SWING_LR_ANGLE;
    }
    ...
    getSwingAngleCurrentVerticalTiltAngle(): CharacteristicValue {
        return this.device.attributes.WIND_SWING_UD_ANGLE === 1
            ? 0
            : this.device.attributes.WIND_SWING_UD_ANGLE;
    }
    ...
    getSleepMode(): CharacteristicValue {
        return this.device.attributes.POWER === true &&
            this.device.attributes.SLEEP_MODE
            ? this.platform.Characteristic.Active.ACTIVE
            : this.platform.Characteristic.Active.INACTIVE;
    }
    ...
    getComfortMode(): CharacteristicValue {
        return this.device.attributes.POWER === true &&
            this.device.attributes.COMFORT_MODE
            ? this.platform.Characteristic.Active.ACTIVE
            : this.platform.Characteristic.Active.INACTIVE;
    }
